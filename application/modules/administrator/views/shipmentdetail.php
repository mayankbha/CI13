...
<?php //echo 'Total Shipped :: '.$shipped.' ==== Total Received :: '.$shipment_total_received_product; ?>
								...
								<div class="row">
									...
									<div class="col-md-12" style="margin-bottom:10px;">
										...
										<div class="col-md-2">
											...
											<div>
												<?php if($shipped == $shipment_total_received_product) { ?>
													RECEIVED
												<?php } else { ?>
													RECEIVING 
												<?php } ?>
											...
											<tbody>
												<?php if(is_array($shipmentProductsDetail)) { ?>
													<?php $sno = '1'; foreach($shipmentProductsDetail as $row) { ?>
														<?php $encoded = urlencode(base64_encode($row['product_id']));?>
														...
														<tr>
															...
															<td class="shipment_detailsadmin" id="item_received_qty<?php echo $sno; ?>"><?php echo $row['received']; ?></td>
															<td class="shipment_detailsadmin" id="edit_link_col<?php echo $sno; ?>">
																<a id="edit_link_<?php echo $sno; ?>" href="javascript: void(0);" onclick="showEditProductSection('<?php echo $shipment_id; ?>', '<?php echo $encoded; ?>', <?php echo $sno; ?>);" class="common_class m_show">Edit</a></td>
														</tr>
													<?php $sno++; } ?>
												<?php } ?>
											</tbody>
