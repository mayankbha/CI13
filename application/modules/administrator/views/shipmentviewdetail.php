			...
			<div class="container">
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<a href="<?php echo base_url('administrator/ViewController/shipmentViewDetails'); ?>" title="">Shipping Queue</a>
						</li>
					</ul>
				</div>  
				...
				<div class="row">
					...
					<div class="col-md-4" style="padding-top:31px;">
						<div class="alert alert-info" align="center">
							<a href="<?php echo base_url('administrator/ViewController'); ?>" style="color:#428bca;text-decoration:none;"><b>Go Back To Admin Console</b></a>
						</div>
					</div>
					<div class="col-md-4 page-header">
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						...
						<div class="tab-content row">
							<div class="tab-pane <?php if(isset($plan_type) && ($plan_type)==1){ echo 'active';} ?>" id="shipments">
								<form  method="POST"  id="searchShpimemet" action="<?php echo base_url('administrator/ViewController/search'); ?>">
								<div class="row">
									<div class="col-md-1">
											...
											<table class="table table-striped table-bordered table-hover table-checkable datatable">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a  href="<?php echo base_url('administrator/ViewController/viewShipment?shipment_id='.$item->shipment_id); ?>" class="btn btn-primary btntrack Shipment viewShipment" >View Shipment  </a>  
														</td>		
													<!--	<td>
							...
							<div class="tab-pane <?php if(isset($plan_type) && ($plan_type)==0){ echo 'active';} ?>" id="shipping_plans">
								<form  method="POST" id="searchShpimemetForm"   action="<?php echo base_url('administrator/ViewController/search_in_plan_type'); ?>">
									<div class="row">
										<div class="col-md-1">
												...
												<table class="table table-striped table-bordered table-hover table-checkable datatable">
													...
													<tbody>
														...
														<tr>
															...
															<?php// } else if($item->step > 6){ ?>
																<a  href="<?php //echo base_url('administrator/ViewController/viewShipment?shipment_id='.$item->shipment_id); ?>" class="btn btn-primary btntrack Shipment viewShipment" >View Shipment   
																</a>
