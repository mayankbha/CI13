	...
	<div class="row">		
		<div style="background-color:#F9F9F9;height:575px;">  
			<div style="float:right;">
				<img src="<?php echo base_url('assets/img/shipstation.png');?>" width="300px" style="padding-top:10px;">
			...
			<div style="border:1px solid #D9D9D9;height:350px;margin-left: 15px; margin-right: 15px;">
				...
				<span style="margin-top: 35px;margin-left: 30px;font-family:Raleway;font-size:16px;color:black;">
					<?php echo $this->lang->line('Shipstation_succes_emailT'); ?>
				</span><br /><br />
				<span style="margin-top: 35px;margin-left: 30px;font-family:Raleway;font-size:16px;color:black;">
					<?php echo $this->lang->line('We_have_synchronized_Products'); ?>
				</span><br /><br /><br /><br />
				<span style="margin-top: 35px;margin-left: 30px;font-family:Raleway;font-size:16px;color:black;">
