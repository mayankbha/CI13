...
<table class="table table-striped table-bordered table-checkable table-highlight-head table-no-inner-border table-hover">
	<thead>
		<tr style="border-color:white;">
			...
			<th class="label_cost">Label Cost</th>
			<th></th>
		</tr>
	</thead>
	<?php if(!empty($items)){ ?>	
	...
	<style>
		...
		<tr>
			...
			<td class="label_cost">
				<span id="myPopoverlabel_-<?php echo $item->item_id; ?>" rel="popover" data-popover-content="#myPopoverlabel_<?php echo $item->item_id; ?>" data-placement="left" class="labelcostpopover"><span id="lcost-<?php echo $item->item_id; ?>"><?php echo $item->label_cost; ?></span>
				
				<div class="row">
					<div id="myPopoverlabel_<?php echo $item->item_id; ?>" class="hide" style="max-width: 387px !important; top: 132.25px; left: 714px; display: block; z-index: 1050; padding: 0px;">
						...
						<!--<div class="popover-content">
							...
							<div class="popover-title2">
								<span id="myPopoverlabelcost_<?php //echo $item->item_id; ?>" >
									<?php// echo $item->item_label .'*'. 0.10 .'='.$item->label_cost; ?>
								</span>
								<br />
							</div>
							<div class="">
						...
						<div class="popover-content">
							<div class="popover-title">
								<span id="myPopoverlabelcost_<?php echo $item->item_id; ?>" style="margin-left:30px;margin-right:30px;">
									...
									<?php echo $item->item_label ."&nbsp;<img src='http://hubway.upworkdevelopers.com/assets/img/multiply.png' width='10'>&nbsp;". 0.10 .'='.$item->label_cost; ?>
							...
							<div class="popover-text">
								<span class="pull-right"><?php echo $item->item_label;?></span>Labels to be printed <br />
								<span class="pull-right">0.10</span>Label Charges  <br />
							
							</div>
							<div class="popover-title2">
								<span class="pull-right"><?php echo "$".$item->label_cost;?></span>Total <br />
							</div>
							<div class="">
								<p></p>
							</div>
		...
		<div class="col-md-6">
			<div class="row">
				...
				<div class="col-md-4 fileinput-preview uneditable-input ">
					...
					<!--<input name="label[]" data-style="fileinput" id="file_label"  type="file" multiple />-->
					<br /><br />
	...
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				...
				<!---<div class="col-md-4">
					<input id="carton_file" type="file" name="carton[]"  data-style="fileinput" multiple />
					</br>
					<div class="progress">
						<div id="progress-bar_file2" class="progress-bar bg-success" style="width: 0%"   ></div>
					</div></br>
					<input name="cartonimage"  type="text"  value="<?php //echo $order->carton_images; ?>" style="visibility: hidden" required />
				...
				<div class="col-md-3">
					<!--<button class="btn btn-primary" id="carton_file_btn"> Upload  </button>--->
				</div>
			</div>
	</br>
			</br>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="row">
				...
				<!--<div class="col-md-4">
					<input id="shipping_label_file" type="file" name="shipping_label[]"  data-style="fileinput" multiple  />
					</br>
					<div class="progress">
						<div id="progress-bar_file3" class="progress-bar bg-success" style="width: 0%"   ></div>
					</div>
					</br>
					<input name="shipping_labelimage"  type="text" style="visibility: hidden" value="<?php //echo $order->shipping_label_images?>"  required/>
				</div>-->
				...
				<div class="col-md-3">
					...
					<!--<button class="btn btn-primary" id="shipping_label_file_btn"> Upload  </button>-->
				</div>
			</div>
			<!--<div id="progress-wrp2" style="display:none;">
				<div class="progress-bar-success2">
				</div >
...
<script type="text/javascript" src="http://envato.stammtec.de/themeforest/melon/plugins/fileinput/fileinput.js"></script>
<script type="text/javascript"> 
function updateorderLabel(id) {
	var label	=	$('#order_label'+id).val(); 
	var label_to_cost	=	parseFloat(label*0.10).toFixed(2);
	$('#myPopoverlabelcost_'+id).text(label+"*"+0.10+"="+label_to_cost);
	$.ajax({
		type: 'POST',
