<style>
.custm_display{
	display:<?php  if(isset($order)  && ($order->totaloutbound)) { echo "block";  }else{ echo "none"; } ?>
}
									...
									<div class="tab-pane active" id="tab_1_1">
										...
										<div class="row">
											<div class="col-md-8 col-md-offset-2" style="background-color:#D9EDF7;padding-top:15px;padding-bottom:15px;">
												<a id="displayText" href="javascript:toggle();" style="text-decoration:none;">
													<img src="<?php echo base_url('assets/img/PLUS.png'); ?>" width="20px"/>
												</a>
												<span class="outboundCharges">Outbound Charges</span>
												
												<span class="outboundChargesprice">$<?php if(isset($order) && $order->totaloutbound!=null){ echo $order->totaloutbound; } else { echo 0; } ?></span>
												...
												<table class="table table-striped table-hover">
													<thead>
														...
														<tr>
															...
															<td class="close1">
																<img src="<?php echo base_url('assets/img/close_big.png'); ?>" width="13px"/>
															</td>
															<td class="quanity1">
															...
															<td class="outboundprince">
																<span class="CubicFeet2">Outbound Charges<br /><center>$0.22</center><br /></span>
															</td>
															<td class="close1">
																<img src="<?php echo base_url('assets/img/equal_sign1600.png'); ?>" width="25px"/>
															</td>
															<td class="quanity1">
																<span class="sku2">Total Charges</span>
															</td>
														</tr>
													</thead>
													<tbody>
														...
														<?php  $obcharge =0; foreach($items as $key=> $item) { ?>
															...
															?>
																...
																<td class="close1">
																<img src="<?php echo base_url('assets/img/close_big.png'); ?>" style="margin-left: 0px;" width="13px"/>
																</td>
																<td class="outboundprince">
																	<span class="outboundprince1" ><?php echo $item->quantity; ?></span>
																</td>
																<td class="close1">
																	<img src="<?php echo base_url('assets/img/close_big.png'); ?>" width="13px" style="margin-left: 5px;" />
																</td>
																<td class="outboundprince">
																	<span style="font-size: 15px;margin-left: 0px;" >$0.22 </span>
																</td>
																<td class="close1">
																<img src="<?php echo base_url('assets/img/equal_sign1600.png'); ?>" style="margin-left: 3.7px;" width="25px"/>
															</td>
																<td class="outboundprince">
																	<span style="font-size: 15px;padding-left: 0px;">$<?php $ob = $item->quantity*$item->item_dimension*0.22;
																	echo $ob;
																	$obcharge+= $ob;
																	?></span>
																</td>
										...
										<div class="row">
											<div class="col-md-7 col-md-offset-4">
												<span style="font-size: 18px;padding-left: 318px;">Total Charges</span>
												
												
												<span class="pull-right" style="font-size: 18px; padding-right: 178px;" rel="popover" data-popover-content="#myPopover123aa" data-placement="left" id="totalCharges123">$<?php echo $obcharge+$sum; ?></span>
...
function toggle() {
	...
	if(ele.style.display == "block") {
		...
		text.innerHTML = "<img src='<?php echo base_url('assets/img/PLUS.png');?>' width='20px' />";
		$('#hidehr1').show();
  	} else {
		ele.style.display = "block";
		text.innerHTML = "<img src='<?php echo base_url('assets/img/sub.png');?>' width='20px' />";
		$('#hidehr1').hide();
	}
} 
