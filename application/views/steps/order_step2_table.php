		...
		<?php foreach($inventoryData as $row){ ?>
			<tr>
				<td class="checkbox-column">
					<input type="checkbox" name="inventory" class="uniform customCheck" onclick="checkFunctionOrder('<?php echo $row->inventory_id; ?>')" id="<?php echo $row->inventory_id; ?>"  value="<?php echo $row->inventory_id; ?>" <?php
